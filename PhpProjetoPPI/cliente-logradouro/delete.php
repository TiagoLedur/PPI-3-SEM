...
if (isset($_GET['id_clientelog'])) {
    ...
    if (isset($_GET['confirmar']) && $_GET['confirmar'] == 'true') {
        ...
        try {
            ...
            $sql = "DELETE FROM cliente_logradouro WHERE id_clientelog = :id_clientelog";
            $stmt = $conn->prepare($sql);
            $stmt->bindParam(':id_clientelog', $id_clientelog, PDO::PARAM_INT);
            $stmt->execute();
            ...
            <head>
                ...
                <title>Exclusão de Cliente Logradouro</title>
        ...
        <body>
            <div class="container text-center">
                ...
                <a href="delete.php?id_clientelog=' . $id_clientelog . '&confirmar=true" class="btn btn-danger">Sim, Excluir</a>
    ...
    // Caso o id_clientelog não seja fornecido
    echo 'ID do cliente logradouro não fornecido.';
}
?>
